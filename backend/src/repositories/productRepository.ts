  ...
  for (let c = 0; c < SAREE_CATEGORIES_20.length; c++) {
    ...
    for (let p = 1; p <= 4; p++) {
      ...
      list.push({
        ...
        colors: ['Royal Crimson Red', 'Mustard Gold', 'Emerald Green', 'Peacock Blue'],
        variants: [
          { colorName: 'Royal Crimson Red', hexColor: '#990000', stock: 12 + (globalIdCounter % 15), status: 'active', sku: `SKU-${1000 + globalIdCounter}-RED`, price: discountPrice, images: gallery },
          { colorName: 'Mustard Gold', hexColor: '#D4AF37', stock: 8 + (globalIdCounter % 10), status: 'active', sku: `SKU-${1000 + globalIdCounter}-GLD`, price: discountPrice, images: gallery },
          { colorName: 'Emerald Green', hexColor: '#006633', stock: 0, status: 'inactive', sku: `SKU-${1000 + globalIdCounter}-GRN`, price: discountPrice, images: gallery },
          { colorName: 'Peacock Blue', hexColor: '#003366', stock: 10 + (globalIdCounter % 8), status: 'active', sku: `SKU-${1000 + globalIdCounter}-BLU`, price: discountPrice, images: gallery },
        ],
