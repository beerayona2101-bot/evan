...
<<<<<<< HEAD
    <div className="fixed inset-0 bg-slate-950/80 backdrop-blur-md z-50 flex items-center justify-center p-4 overflow-y-auto">
      <div className="bg-white rounded-3xl border border-red-300 shadow-2xl max-w-md w-full p-6 sm:p-8 space-y-5 animate-in fade-in zoom-in-95 duration-200">
...
<<<<<<< HEAD
        ...
        {/* Predefined Reasons Selection Form */}
        <form onSubmit={handleSubmitAdminCancel} className="space-y-4 text-xs font-semibold">
          <div>
